...
- **Case squares** (dashboard): file ID, client and flag, headline and date, then along the bottom the status (a coloured dot) and two round buttons, + for a follow-up and ✉ for email. The List view and Activity keep one-line bars with a date tile, countdown and the last follow-up.
